...
class PredictionAccuracy(Base):
    ...
    within_interval: Mapped[Optional[bool]] = mapped_column()
    direction_correct: Mapped[Optional[bool]] = mapped_column()
    matched_column: Mapped[Optional[str]] = mapped_column(String(30))
    data_origin: Mapped[Optional[str]] = mapped_column(String(20))
